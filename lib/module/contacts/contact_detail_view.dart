    ...
    return new Theme(
      ...
      child: new Scaffold(
        ...
        appBar: new AppBar(centerTitle: true,
                  title: new Row(children: [Text(_contact.fullName), 
                   //new Center(child:new Image.network(_contact.imageUrl)) 
                   ]),),
        body: 
                  new ListView(
                    ...
                    children: 
                      <Widget>[
                          //new Center( child: new Image.network(_contact.imagelargeUrl)),
                          _showImage(_contact.imageLargeUrl),
                          _buildPhoneCategory(),
...
Widget _showImage(String url){
  return new Container(
             ...
             decoration: new BoxDecoration(
               ...
               borderRadius: new BorderRadius.all(new Radius.circular(400.0)),
